node
{
    ...
    {
        notifyBuild('STARTED')
        git branch: 'devlopment', url: 'https://github.com/Rambabu1583/maven-webapplication-project-kkfunda.git'
    }
    stage('build')
    {
...
def notifyBuild(String buildStatus = 'STARTED') {
  ...
  slackSend (color: colorCode, message: summary, channel: '#jio-testing')
}
